...
Begin by fine tuning the buying and selling prices from the past 14 days of historical price data. 
        ...
        in the python code lines 263 and 265: 
         percent_to_add_to_low_buy_price = 1    # 1 is the default setting ( + 0% change )
        
         percent_to_subtract_from_high_sell_price = 0.985  # Factor to reduce the sell price by 1.5%

This stock trading bot buys stocks based on a target buy price, which is calculated as ( lowest_price * 1 ) 0% above the lowest price observed over the last 14 days. Here's how it works:
